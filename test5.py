...
class SERVO_MAN(Variables,Player,Default_position,
    ...
    def __init__(self, master):
        ...
        ########################
        self.servo_executer_ = 0
        self.servo_executer_1 = 0
        self.servo_executer_2 = 0
        self.servo_executer_3 = 0
        self.servo_executer_4 = 0
        self.servo_executer_5 = 0
        self.servo_executer_6 = 0
        self.servo_executer_7 = 0
        self.servo_executer_8 = 0
        #########################
        self.loop_speed1=0
        self.loop_speed2=0
        self.loop_speed3=0
    ...
    def count_clicks(self):
        ...
        if self.count == 2:
            ...
            #                                             len(execute))
            final_execute = self.return_decide(execute,self.first_p,self.second_p,len(execute),self.min_interval,
                                          self.servo_executer_,self.servo_executer_1,
                                          self.servo_executer_2,self.servo_executer_3,
                                          self.servo_executer_4,self.servo_executer_5,
                                          self.servo_executer_6,self.servo_executer_7,
                                          self.servo_executer_8,
                                          0,self.indicator_,self.second_p[0],interval_servo[0],self.first_p[0],
                                          2,self.indicator_1,self.second_p[2],interval_servo[1], self.first_p[2],
                                          4,self.indicator_2,self.second_p[4],interval_servo[2], self.first_p[4],
                                          6,self.indicator_3,self.second_p[6],interval_servo[3], self.first_p[6],
                                          8,self.indicator_4,self.second_p[8],interval_servo[4], self.first_p[8],
                                          10,self.indicator_5,self.second_p[10],interval_servo[5], self.first_p[10],
                                          12,self.indicator_6,self.second_p[12],interval_servo[6], self.first_p[12],
                                          14,self.indicator_7,self.second_p[14],interval_servo[7], self.first_p[14],
                                          16,self.indicator_8,self.second_p[16],interval_servo[8], self.first_p[16])
