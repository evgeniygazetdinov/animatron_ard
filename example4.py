...
class EXAMPLER:
    ...
    def single_repeater(self,angle_for_repeat,key_number):
        ...
        return some_execute
    def changer(self,one_digit,two_digit):
        one_duplicate = one_digit
        two_duplicate = two_digit
        if one_digit < two_digit:
            two_duplicate = one_digit
            one_duplicate = two_digit
    ...
    def divider_angle(self,basic_angle,min,interval_servo,
        ...
        # think about why quantity key in one time immadently changed
        min_interval = min
    ...
    #
    #
    #     def checker(self,number,variable,*val,*):
    #         check_true = {str(i):[False] for i in range(9)}
    #         if args ==  number:
    #             check_true.values()[number] = True
    #             return variable
    #                 {
    #                 '0': lambda number: x/y,
    #                 '1': lambda number: x+y,
    ...
    def switcher(self,first_serif,second_serif,
                 position,indificator,basic_angle,interval_servo,begin_divider,min,key_number):
        # here will come decide who will divide or repeate
    ...
    def put_values_in_interval(self,execute,servo_execute_,
                               servo_execute_1,servo_execute_2,
                               servo_execute_3,servo_execute_4,
                               servo_execute_5,servo_execute_6,
                               servo_execute_7,servo_execute_8):
        print(servo_execute_)
        print(servo_execute_1)
        print(servo_execute_2)
        print(servo_execute_3)
        print(servo_execute_4)
        print(servo_execute_5)
        print(servo_execute_6)
        print(servo_execute_7)
        print(servo_execute_8)
        for i ,value in enumerate(execute.values()):
            value[0] = servo_execute_[i]
            value[2] = servo_execute_1[i]
            value[4] = servo_execute_2[i]
            value[6] = servo_execute_3[i]
            value[8] = servo_execute_4[i]
            value[10] = servo_execute_5[i]
            value[12] = servo_execute_6[i]
            value[14] = servo_execute_7[i]
            value[16] = servo_execute_8[i]
        return execute




    def return_decide(self,execute,first_serif,second_serif,key_number,min,v,
                      v1,v2,v3,v4,v5,v6,v7,v8,
                    position1,indificator1,basic_angle1,interval_servo1,begin_divider1,
                    position2,indificator2,basic_angle2,interval_servo2,begin_divider2,
                     position3,indificator3,basic_angle3,interval_servo3,begin_divider3,
                      position4,indificator4,basic_angle4,interval_servo4,begin_divider4,
                       position5,indificator5,basic_angle5,interval_servo5,begin_divider5,
                        position6,indificator6,basic_angle6,interval_servo6,begin_divider6,
                         position7,indificator7,basic_angle7,interval_servo7,begin_divider7,
                          position8,indificator8,basic_angle8,interval_servo8,begin_divider8,
                          position9,indificator9,basic_angle9,interval_servo9,begin_divider9):

        v = self.switcher(first_serif,second_serif,position1,indificator1,basic_angle1,
                          interval_servo1,begin_divider1,min,key_number)
        v1 =self.switcher(first_serif,second_serif,position2,indificator2,basic_angle2,
                          interval_servo2,begin_divider2,min,key_number)
        v2 = self.switcher(first_serif,second_serif,position3,indificator3,basic_angle3,
                           interval_servo3,begin_divider3,min,key_number)
        v3 = self.switcher(first_serif,second_serif,position4,indificator4,basic_angle4,
                           interval_servo4,begin_divider4,min,key_number)
        v4 = self.switcher(first_serif,second_serif,position5,indificator5,basic_angle5,
                           interval_servo5,begin_divider5,min,key_number)
        v5 = self.switcher(first_serif,second_serif,position6,indificator6,basic_angle6,
                           interval_servo6,begin_divider6,min,key_number)
        v6 = self.switcher(first_serif,second_serif,position7,indificator7,basic_angle7,
                           interval_servo7,begin_divider7,min,key_number)
        v7 = self.switcher(first_serif,second_serif,position8,indificator8,basic_angle8,
                           interval_servo8,begin_divider8,min,key_number)
        v8 = self.switcher(first_serif,second_serif,position9,indificator9,basic_angle9,
                          interval_servo9,begin_divider9,min,key_number)


        execute = self.put_values_in_interval(execute,v,v1,v2,v3,v4,
                                    v5,v6,v7,v8)
