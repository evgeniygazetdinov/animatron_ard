...
class Demo2:
    def __init__(self, master):
        ...
        self.check_1 = ttk.Button(self.master, text='add angle', command=self.refresh).grid(row=2, column=1)
        self.angle_box1.grid(row=1, column=1)
        self.angle_box1.insert(END, 0)
        self.angle_box1 = tk.StringVar()
        ...
        self.angle_box3.insert(END, 0)
        self.angle_box3 = tk.StringVar()
    ...
    def refresh(self):
        an_left_e = StringVar()
        an_right_e = StringVar()
        an_right_sholder = StringVar()
        an_right_hand = StringVar()
        an_left_hand = StringVar()
        an_left_leg = StringVar()
        an_right_leg = StringVar()

        an_left_e.set(0)
        an_right_e.set(0)
        an_right_sholder.set(0)
        an_right_hand.set(0)
        an_left_hand.set(0)
        an_left_leg.set(0)
        an_right_leg.set(0)
   ...
   ########################################################
    def time_lapse(self):#time scaling
        ...
        for i in range(7):
            self.temp_varibal.append(self.angles[i])
    ...
    def just_one_action2(self):
        ...
        self.left_e.write(self.angles[1])
        self.right_sholder.write(self.angles[2])
        self.right_hand.write(self.angles[3])
        self.left_hand.write(self.angles[4])
        self.left_leg.write(self.angles[5])
        self.right_leg.write(self.angles[6])
        print(self.angles[0])
